...
const Header = (props) => {
  return (
    <div className={`header-container-client ${props.rootClassName} `}>
      <header data-role="Header" className="header-header">
        <div className="header-container1">
          <Link to="/" className="header-navlink">
            <img
              alt="logo"
              src="/playground_assets/headerlogo-1500h.png"
              className="header-ini-logo"
            />
          </Link>
          <Link to="/" className="header-navlink1">
            <img
              alt="logo"
              src="/playground_assets/finalclientlogoinabelniinawhitetextonly11177-z827-200h.png"
              className="header-ini-typography"
            />
          </Link>
        </div>
        ...
        <div className="header-btn-group">
          <Link to="/cart" className="header-navlink2">
            <img
              alt={props.image_alt}
              src="/playground_assets/cart.svg"
              className="header-image"
            />
          </Link>
          <Link to="/log-in" className="header-navlink3">
            <img
              alt={props.image_alt1}
              src="/playground_assets/profile.svg"
...
Header.defaultProps = {
  image_alt: "image",
  image_alt1: "image",
  image_src: "9863935d-ee79-4b05-a199-61e81dd67ebe",
  rootClassName: "",
};
